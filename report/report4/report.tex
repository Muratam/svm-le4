...
\subsubsection{sin波}
\begin{figure}[htbp]
 \graphs{0.4}{./plots/sin4.png}{$b = 0.2$}
 \graphs{0.4}{./plots/sin1.png}{$b = 0.5$}
 \caption{$f(x)=sin(10x)$ による予測値(赤:実値,青:予測値) }
 \graphs{0.4}{./plots/2sin2.png}{$b = 0.2$}
 \graphs{0.4}{./plots/2sin1.png}{$b = 0.5$}
 \caption{$f(x)=sin(10x)$ による予測値(赤:実値,青:予測値) }
\end{figure}
sin波は、周期的な規則性があるため、少ないサンプル数でもほどよい予測ができる事がわかる
但し、図1(a)のように、sin波の全景なしでは予測は不可能である。
